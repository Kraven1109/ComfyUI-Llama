...
class GGUFLoader:
    ...
    def INPUT_TYPES(s):
        ...
        for root, dirs, files in os.walk(models_dir, followlinks=True):  # ✅ Follow symlinks
            for file in files:
        ...
        return {
            "required": {
                "gguf_name": (gguf_files, {"default": gguf_files[0] if gguf_files else ""}),  # Includes symlinked files
            },
            "optional": {
                "gguf_path_override": ("STRING", {"default": ""}),  # Keep this for manual override
            },
        }
