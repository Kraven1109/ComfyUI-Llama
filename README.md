...
- 🦙 **GGUF Inference** via llama-server HTTP API (one-shot: load → infer → unload)
- 🤗 **HuggingFace Models** with 4-bit/8-bit quantization (bitsandbytes)
- 🖼️ **Vision-Language Support** for image understanding
- 📦 **Flexible Model Loading** from local files or HuggingFace Hub
- 🛠️ **Prompt Building** with templates and variables
- 👁️ **Text Preview** with copy functionality and persistence
...
### Method 1: GGUF with llama-server
...
**Supported Models:**
- `huihui-ai/Huihui-Step3-VL-10B-abliterated` (custom architecture)
